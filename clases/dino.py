...
class Dino:
    ...
    def __init__(self, un_nombre=None, un_color=None):
        ...
        self.color = un_color
        print("Hola soy un dinosaurio, me llamo ",
              self.nombre, "y soy ", self.color)
    ...
    # es un metodo getter o metodo para obtener un atributo del objeto
...
##### HERENCIA
class TRex(Dino): #Se crea la clase TRex que hereda los atributos y metodos de la clase Dino
...
pepex.comer_gente()
pepex.comer_gente()
print("Hasta el momento me comi ", pepex.gente_comida, "personas")
